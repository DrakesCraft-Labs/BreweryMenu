...
public class BreweryMenu extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        ItemStack breweryGroupItem = new CustomItemStack(Material.POTION, "&eDestilar", "", "&aExplora el mundo de la destilación...");
        ...
        SlimefunItemStack cauldron_stack = new SlimefunItemStack("BREWERY", Material.CAULDRON, "&eDestilar");
        SlimefunItemStack skotska_whisky_stack = new SlimefunItemStack("SKOTSKA_WHISKY", Material.POTION, "&eWhisky escocés");
        configureMeta(skotska_whisky_stack, createNewColor(186,125,84));
        SlimefunItemStack irska_whisky_stack = new SlimefunItemStack("IRSKA_WHISKY", Material.POTION, "&eWhisky irlandés");
        ...
        SlimefunItemStack psenicne_pivo_stack = new SlimefunItemStack("PSENICNE_PIVO", Material.POTION, "&eCerveza de malta");
        ...
        SlimefunItemStack jablecny_most_stack = new SlimefunItemStack("JABLECNY_MOST", Material.POTION, "&eZumo de manzana");
        ...
        SlimefunItemStack houbova_vodka_stack = new SlimefunItemStack("HOUBOVA_VODKA", Material.POTION, "&eVodka de setas");
        ...
        SlimefunItemStack bramborova_polevka_stack = new SlimefunItemStack("BRAMBOROVA_POLEVKA", Material.POTION, "&eSopa de patata");
        configureMeta(bramborova_polevka_stack, Color.ORANGE);
        SlimefunItemStack kava_stack = new SlimefunItemStack("KAVA", Material.POTION, "&eCafé");
        ...
        ItemStack[] cauldron_recipe = {null, null, null, null, createMultiblockRecipe(Material.CAULDRON, "Llénalo de agua"), null, createMultiblockRecipe(Material.COBBLESTONE_STAIRS, "El fuego tiene que estar rodeado de escaleras"), createMultiblockRecipe(Material.FLINT_AND_STEEL, "Necesita fuego u otra fuente de calor"), createMultiblockRecipe(Material.COBBLESTONE_STAIRS, "El fuego tiene que estar rodeado de escaleras")};
        ItemStack[] skotska_whisky_recipe = {createRecipeItem("Trigo", 9, Material.WHEAT), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 2), null, null, null, null, createBarrel("Barril de roble", 10), createClock(4), createBrewingStand(2)};
        ItemStack[] irska_whisky_recipe = {createRecipeItem("Trigo", 8, Material.WHEAT), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 2), null, null, null, null, createBarrel("Barril de roble", 3), createClock(4), createBrewingStand(3)};
        ItemStack[] bourbon_recipe = {createRecipeItem("Trigo", 4, Material.WHEAT), createRecipeItem("BM_MAIZ", "9bd3802e5fac03afab742b0f3cca41bcd4723bee911d23be29cffd5b965f1", "&eMaíz", 5), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 1), null, null, null, createBarrel("Barril de roble", 3), createClock(4), createBrewingStand(2)};
        ItemStack[] psenicne_pivo_recipe = {createRecipeItem("Trigo", 3, Material.WHEAT), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 1), null, null, null, null, createBarrel("Barril de abedul", 2), createClock(8), null};
        ItemStack[] pivo_recipe = {createRecipeItem("Trigo", 6, Material.WHEAT), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 2), null, null, null, null, createBarrel("Cualquier barril", 3), createClock(8), null};
        ItemStack[] tmavy_lezak_recipe = {createRecipeItem("Trigo", 12, Material.WHEAT), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 1), null, null, null, null, createBarrel("Barril de roble oscuro", 8), createClock(8), null};
        ...
        ItemStack[] medovina_recipe = {createRecipeItem("Botella de miel", 4, Material.HONEY_BOTTLE), createRecipeItem("Azúcar", 2, Material.SUGAR), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 2), null, null, null, createBarrel("Barril de roble", 4), createClock(3), null};
        ItemStack[] jablecna_medovina_recipe = {createRecipeItem("Botella de miel", 6, Material.HONEY_BOTTLE), createRecipeItem("Manzana", 2, Material.APPLE), createRecipeItem("BM_LEVADURA", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 1), null, null, null, createBarrel("Barril de roble", 4), createClock(4), null};
        ...
        ItemStack[] jablecny_liker_recipe = {createRecipeItem("Manzana", 12, Material.APPLE), createRecipeItem("Azúcar", 3, Material.SUGAR), null, null, null, null, createBarrel("Barril de acacia", 6), createClock(16), createBrewingStand(3)};
        ItemStack[] rum_recipe = {createRecipeItem("BM_MAIZ", "9bd3802e5fac03afab742b0f3cca41bcd4723bee911d23be29cffd5b965f1", "&eMaíz", 18), null, null, null, null, null, createBarrel("Barril de roble", 14), createClock(6), createBrewingStand(2)};
        ItemStack[] vodka_recipe = {createRecipeItem("Patata", 16, Material.POTATO), null, null, null, null, null, null, createClock(15), createBrewingStand(3)};
        ItemStack[] houbova_vodka_recipe = {createRecipeItem("Patata", 14, Material.POTATO), createRecipeItem("Seta roja", 3, Material.RED_MUSHROOM), createRecipeItem("Seta marrón", 3, Material.BROWN_MUSHROOM), null, null, null, null, createClock(18), createBrewingStand(5)};
        ItemStack[] gin_recipe = {createRecipeItem("Trigo", 9, Material.WHEAT), createRecipeItem("Orquídea", 6, Material.BLUE_ORCHID), createRecipeItem("Manzana", 1, Material.APPLE), null, null, null, null, createClock(6), createBrewingStand(2)};
        ...
        ItemStack[] zeleny_absinth_recipe = {createRecipeItem("Hierba", 17, Material.SHORT_GRASS), createRecipeItem("Patata venenosa", 2, Material.POISONOUS_POTATO), null, null, null, null, null, createClock(5), createBrewingStand(6)};
        ItemStack[] bramborova_polevka_recipe = {createRecipeItem("Patata", 5, Material.POTATO), createRecipeItem("Hierba", 3, Material.SHORT_GRASS), null, null, null, null, null, createClock(3), null};
        ItemStack[] kava_recipe = {createRecipeItem("Grano de cacao", 12, Material.COCOA_BEANS), createRecipeItem("Cubo de leche", 2, Material.MILK_BUCKET), null, null, null, null, null, createClock(2), null};
        ItemStack[] vajecnak_recipe = {createRecipeItem("Huevo", 5, Material.EGG), createRecipeItem("Azúcar", 2, Material.SUGAR), createRecipeItem("Cubo de leche", 1, Material.MILK_BUCKET), null, null, null, createBarrel("Cualquier barril", 3), createClock(2), null};
    ...
    private ItemStack createClock(int i) {
        ...
        lore.add(i + " minutos");
        ItemStack clock = new CustomItemStack(Material.CLOCK, "&aTiempo de cocción");
    ...
    private ItemStack createBrewingStand(int i) {
        List<String> lore = new ArrayList<>();
        lore.add(i + " veces: ");
        ItemStack brewingStand = new CustomItemStack(Material.BREWING_STAND, "&aDestilaciones");
    ...
    //        swMeta.addItemFlags(ItemFlag.HIDE_ADDITIONAL_TOOLTIP);
