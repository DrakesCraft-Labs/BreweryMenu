...
public class BreweryMenu extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        ItemStack[] medovina_recipe = {createRecipeItem("Botella de miel", 4, Material.HONEY_BOTTLE), createRecipeItem("Azúcar", 2, Material.SUGAR), createRecipeItem("Levadura", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 2), null, null, null, createBarrel("Barril de roble", 4), createClock(3), null};
        ItemStack[] jablecna_medovina_recipe = {createRecipeItem("Botella de miel", 6, Material.HONEY_BOTTLE), createRecipeItem("Manzana", 2, Material.APPLE), createRecipeItem("Levadura", "606be2df2122344bda479feece365ee0e9d5da276afa0e8ce8d848f373dd131", "&eLevadura", 1), null, null, null, createBarrel("Barril de roble", 4), createClock(4), null};
        ...
        ItemStack[] rum_recipe = {createRecipeItem("Maíz", "9bd3802e5fac03afab742b0f3cca41bcd4723bee911d23be29cffd5b965f1", "&eMaíz", 18), null, null, null, null, null, createBarrel("Barril de roble", 14), createClock(6), createBrewingStand(2)};
